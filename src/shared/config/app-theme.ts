...
export const iconRows: IconRows = [
  ...
  },
  {
    ...
    icons: [
      ['book-heart', 'fad'],
      ['camera-web', 'fad'],
      ['whiskey-glass-ice', 'fad'],
      ['coffee-pot', 'fad'],
      ['users-viewfinder', 'fad'],
      ['turntable', 'fad'],
      ['people-arrows', 'fad'],
      ['block-brick', 'fad'],
      ['message-heart', 'fad'],
  ...
  },
  {
    ...
    icons: [
      ...
      ['trees', 'fad'],
      ['castle', 'fad'],
      ['flask-round-potion', 'fad'],
      ['book-sparkles', 'fad'],
      ['wreath-laurel', 'fad'],
      ['envelope-open-text', 'fad'],
      ['block-brick', 'fad'],
      ['restroom', 'fad'],
    ],
  },
